    ...
    sections = [
        ...
        },
        {
            ...
            'bullets': [
                ...
                "🃏 Cartes : chaque joueur reçoit 3 cartes tirées au hasard parmi 10 (6 atouts + 4 contres) dès l'entrée dans le duel. Tirage seedé sur le duel, donc reproductible.",
                "Tu peux jouer au plus 1 carte par manche : elle remplace une des 3 actions. Une fois posée, la carte est consommée. 3 cartes sur 5 manches = 3 moments tactiques décisifs.",
                "ATOUTS : 🔥 Berserk (Charge ×2 sur ce slot), 💪 Second souffle (+40 endurance immédiat), 🎯 Feinte parfaite (Esquive à 100%), 🤥 Coup bas (Charge traverse un Ancrage sans splat), 🐂 Taurus (Ancrage inflige -50 endu au lieu de -30), 🐷 Grognement (-25 endu immédiat à l'adversaire).",
                "CONTRES : ❌ Contre-atout (annule le 1er atout adverse de la manche), 🧊 Patine (immune à toute poussée à partir du slot joué), ⚡ Vol d'énergie (tu récupères 50 % des coûts endurance de l'adversaire), 🪞 Miroir (50 % de la poussée reçue est renvoyée à l'adversaire).",
                "Les contres peuvent neutraliser les atouts, les cartes à effet long (Patine / Miroir / Vol) couvrent plus ou moins de slots selon où tu les poses — jouer tôt = plus d'impact, jouer tard = plus sûr.",
